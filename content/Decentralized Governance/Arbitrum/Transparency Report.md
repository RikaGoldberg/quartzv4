...
### 1. Foundation Governance: Directors[​](https://docs.arbitrum.foundation/foundational-documents/transparency-report-initial-foundation-setup#1-foundation-governance-directors "Direct link to heading")
...
### 2. Initial Set-up Costs of The Arbitrum Foundation and ArbitrumDAO and Initial Operating Funds[​](https://docs.arbitrum.foundation/foundational-documents/transparency-report-initial-foundation-setup#2-initial-set-up-costs-of-the-arbitrum-foundation-and-arbitrumdao-and-initial-operating-funds "Direct link to heading")
...
### 3. On-Chain DAO Governance[​](https://docs.arbitrum.foundation/foundational-documents/transparency-report-initial-foundation-setup#3-on-chain-dao-governance "Direct link to heading")
...
#### Governance powers breakdown[​](https://docs.arbitrum.foundation/foundational-documents/transparency-report-initial-foundation-setup#governance-powers-breakdown "Direct link to heading")
...
_NOTE: The members list below represents the initial security council members, which are not necessarily the current members; for the list of current members, see [Security Council Members](https://docs.arbitrum.foundation/security-council-members)._
