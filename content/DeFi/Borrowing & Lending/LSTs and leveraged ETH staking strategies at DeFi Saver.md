...
![LSTs and leveraged ETH staking strategies at DeFi Saver](https://blog.defisaver.com/content/images/size/w1200/2023/04/LSTs-and-leveraged-eth-staking-defi-saver.jpg)

The Ethereum Shanghai upgrade, the hard fork that enables validators to withdraw their staked ETH ([EIP-4895](https://eips.ethereum.org/EIPS/eip-4895?ref=blog.defisaver.com)) is [scheduled for tomorrow (April 12th)](https://twitter.com/TimBeiko/status/1636370111333556224?ref=blog.defisaver.com)! This is a huge event for the Ethereum stakers community and its expected to drive even more attention to (liquid) ETH staking narratives and strategies in the DeFi space.
...
The number of validators running on the Beacon Chain has also increased by [around](https://beaconscan.com/stat/validator?ref=blog.defisaver.com) [25%](https://beaconscan.com/stat/validator?ref=blog.defisaver.com) in the last 6 months, boosting the security of the Ethereum network and paving the way to an even more decentralised future.

At the time of writing, there is over 17m of ETH staked, representing around 15% of total ETH supply. Approximately [40%](https://dune.com/queries/46131/90794?ref=blog.defisaver.com) of that staked ETH is staked via pools, with Lido, a decentralised liquid staking protocol, leading the way by taking [more than 77%](https://dune.com/queries/46128/90778?ref=blog.defisaver.com) of the pooled-staking market share.
...
A quick comparison of the three most popular liquid staking options, according to the [](https://ethereum.org/en/staking/pools/?ref=blog.defisaver.com#what-to-consider)[Ethereum.org](https://ethereum.org/en/staking/pools/?ref=blog.defisaver.com#what-to-consider) criteria, boils down to this:

![](https://blog.defisaver.com/content/images/2023/04/LSTs-comparison-lido-rocketpool-coinbase-defi-saver-3.jpg)

But let's also do a quick rundown of each of these three options separately.

### Lido Finance - stETH

As mentioned earlier, [Lido Finance](https://lido.fi/?ref=blog.defisaver.com), a decentralised liquid staking protocol launched back in December 2020, managed to become an [absolute leader](https://dune.com/queries/46128/90778?ref=blog.defisaver.com) in the pooled staking industry when it comes to the amount of ETH staked.

![](https://blog.defisaver.com/content/images/2023/03/Screenshot-2023-03-20-at-10.39.43.png)

Consequently, stETH, Lido's liquid staking token, also has the deepest liquidity across lending markets and decentralised exchanges. Most notably, there's Aave (v2 & v3) and the [Curve stETH/ETH pool](https://classic.curve.fi/steth?ref=blog.defisaver.com), which have around 1.1m of ETH ($2b at the moment), and 400k of both ETH and stETH ($1.5b at the moment), respectively.
...
To learn more about Lido protocol and see how Lido and its validators are performing (security-wise), we recommend checking out their [docs](https://docs.lido.fi/?ref=blog.defisaver.com) and [scorecard](https://lido.fi/scorecard?ref=blog.defisaver.com).
...
To learn more about the RP protocol, check their full docs [here](https://docs.rocketpool.net/overview/faq/?ref=blog.defisaver.com#contact).

### Coinbase - cbETH

Coinbase, the second largest CEX by volume, has launched their version of ETH liquid staking token called [cbETH](https://etherscan.io/token/0xbe9895146f7af43049ca1c1ae358b0541ea49704?ref=blog.defisaver.com) back in August 2022. Until then, the only participants exploring the liquid staking game were DeFi protocols like Lido and RocketPool.
...
![](https://blog.defisaver.com/content/images/2023/03/Screenshot-2023-03-23-at-10.47.37.png)
...
![](https://blog.defisaver.com/content/images/2023/04/LSTs-in-defi-2023.jpg)
...
![](https://blog.defisaver.com/content/images/2023/03/Screenshot-2023-03-16-at-14.43.27.png)

The new leveraged ETH staking dashboard is available here:  
[https://app.defisaver.com/recipes/leveraged-staking](https://app.defisaver.com/recipes/leveraged-staking?ref=blog.defisaver.com)
...
![](https://blog.defisaver.com/content/images/2023/02/strategy-explaination2@2x--1-.png)
...
![](https://blog.defisaver.com/content/images/2023/02/draft3--1-.jpg)
...
> 
> — definikola.eth (@definikola) [April 15, 2022](https://twitter.com/definikola/status/1515064375186538505?ref_src=twsrc%5Etfw&ref=blog.defisaver.com)

### Shifting between different leveraged staking options

In case better opportunities with higher APY arise, users can shift their entire positions (both collateral & debt) to the protocol of their choice using our [Loan Shifter](https://app.defisaver.com/shifter?ref=blog.defisaver.com) dashboard in one go.

![](https://blog.defisaver.com/content/images/2023/02/Screenshot-2023-02-26-at-13.52.12.png)
...
If you are curious about the usage of lev-staking recipes so far (or activity on DFS in general), we recommend checking our recently released stats page at: [](https://stats.defisaver.com/?leverageType=staking&ref=blog.defisaver.com)[https://stats.defisaver.com/](https://stats.defisaver.com/?ref=blog.defisaver.com)!
...
>   
> Check it out today at [https://t.co/loT0FQaLTL](https://t.co/loT0FQaLTL?ref=blog.defisaver.com) - or read on for more details.🧵 [pic.twitter.com/SWC7JnEp4y](https://t.co/SWC7JnEp4y?ref=blog.defisaver.com)
> 
> — DeFi Saver (@DeFiSaver) [February 28, 2023](https://twitter.com/DeFiSaver/status/1630604306503319552?ref_src=twsrc%5Etfw&ref=blog.defisaver.com)
...
![](https://blog.defisaver.com/content/images/2023/03/Screenshot-2023-03-20-at-13.29.57.png)
...
As always, feel free to join us in the [DeFi Saver discord](https://discord.com/invite/XGDJHhZ?ref=blog.defisaver.com) where we'd love to hear all your comments, feedback and suggestions, and you'll always find us available for any questions or assistance needed.
