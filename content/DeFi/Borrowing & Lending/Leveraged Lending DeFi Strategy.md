...
Source: https://simpleswap.io/learn/analytics/strategies/leveraged-lending-defi-strategy
...
In [DeFi](https://simpleswap.io/blog/what-is-defi),** leveraged lending involves using crypto assets as collateral to borrow stablecoins or another crypto.**

By depositing crypto tokens in a smart contract, traders **can take out** **leveraged loans** **in various digital assets** up to a certain percentage of the collateral amount. For example, depositing $1000 in Ethereum can allow for a [crypto loan](https://simpleswap.io/blog/crypto-loans) of $500 in stablecoins DAI. This capital can then be used to open leveraged positions aiming to earn higher yields through DeFi strategies like [yield farming](https://simpleswap.io/learn/analytics/defi/uniswap-yield-farming).
...
Some protocols incentivize participants for providing liquidity or [staking tokens](https://simpleswap.io/learn/analytics/defi/eth-staking-on-lido), rewarding them with **additional tokens** for engaging in these activities.
...
Thus, by following these steps and maintaining leverage, you can achieve a **36.6% APY on your assets**, which is twice the APY for providing assets at 15%. You can continue to increase leverage by repeating these steps, further enhancing your profits.
...
The [Aave](https://docs.aave.com/hub/) protocol is an Ethereum-based lending protocol that provides liquidity and borrowing facilities for various cryptocurrencies. Users can **use their assets as collateral and earn interest**.

What is [Aave crypto](https://simpleswap.io/coins/aave)? Aave cryptocurrency refers to the LEND token, which is used for governance, staking rewards, and payment of platform fees on the Aave protocol. The LEND token allows users to participate in the Aave system by voting on proposals and earning additional rewards.
...
Aave applies **variable interest** rates using a supply and demand algorithmic model. [Aave](https://simpleswap.io/learn/analytics/tech_analysis/aave-technical-analysis) uses a native LEND token for governance, staking rewards, and payment of platform fees.

![aave-protocol-leveraged-lending-scheme](https://weblearn-api.simpleswap.io/learn-web-media/learn-web-media/1_7f4ff54cbb.png)

- **Venus**

[Venus](https://venus.io/) is a lending protocol on the Binance Smart Chain that allows users to **provide liquidity and earn interest for using their assets**. The protocol has its native [Venus crypto](https://simpleswap.io/coins/venus), but users can earn yield by supplying BEP2, BEP8, and BEP20 tokens into Venus liquidity pools. The Venus protocol also **supports lending with collateral** and additional options for leverage.
...
![venus-protocol-leveraged-lending-scheme.png](https://weblearn-api.simpleswap.io/learn-web-media/learn-web-media/2_8a26190e37.png)

- **JustLend**

[JustLend](https://portal.justlend.org/) is a lending protocol offering users the ability to provide liquidity, collateralized lending, and additional leverage options.

![justlend-leveraged-lending-scheme](https://weblearn-api.simpleswap.io/learn-web-media/learn-web-media/3_3bc5f7b1a4.png)

Borrowers can obtain loans by putting up [TRX](https://simpleswap.io/learn/analytics/tech_analysis/trx-technical-analysis), JST, or other TRC20 tokens as collateral. JustLend introduces **credit delegation**, allowing any TRON user to delegate their credit limit to a borrower and earn fees on interest payments. The protocol also **features fast settlement times** and **low fees** compared to Ethereum-based lending platforms.
