---
title: Love vs. Fame
link: https://open.substack.com/pub/li/p/love-vs-fame-a-framework-for-social?utm_source=direct&r=9hhag&utm_campaign=post&utm_medium=web
author: Li Jin
...
[[Crypto enables the creation of new types of networks "socioeconomic" networks which are ownership networks (versus purely social network)]]
...
> ==The dichotomy between these two ends of the spectrum could be summed up as _social networking_ vs. _social media_.
...
> ==Zooming out, the biggest outcomes in social have historically arisen from the creation of new networks: from IRL friend-based networks (Facebook) to interest-based (Reddit, TikTok) to knowledge-based ones (Quora). **There’s an opportunity for crypto to take a crack at building a new type of** _**ownership-based**_ **network that leverages onchain assets as the basis for new communities.** We refer to this idea as a _socioeconomic network_ (versus a purely social network).
